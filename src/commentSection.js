      ...
      <div className="commentsSection">
        <div className="commentHeading">
          ...
          {lastEdit.length ? (
            <div className="lastEdit" title={lastEdit}>
              Edited<div className="lastEditTime">last on {lastEdit}</div>
            </div>
          ) : null}
        </div>
        {!edit ? (
        ...
        <div className="commentFooter">
          <div
            ...
            onClick={() => setReplying((preReplying) => !preReplying)}
          >
            <div className="footerIcon replayIcon">-</div>
            <div className="replayText">{replying ? "Cancel" : "Reply"}</div>
          </div>
          <div
          ...
          >
            ...
            <div className="editText">{edit ? "Cancel" : "Edit"}</div>
          </div>
        </div>
        {reply.map((sub, idx) => (
          <CommentSection
